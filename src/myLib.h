...
#define ATTR2_PAL0 (0 << 12)
#define ATTR2_PAL1 (1 << 12)
#define ATTR2_PAL2 (2 << 12)
#define ATTR2_PAL3 (3 << 12)
#define ATTR2_PAL4 (4 << 12)

#define ATTR2_PRIOR1 (0 << 10)
#define ATTR2_PRIOR2 (1 << 10)
#define ATTR2_PRIOR3 (2 << 10)
#define ATTR2_PRIOR4 (3 << 10)
